...
# WebP画像出力先:
# detapachi/output/<site>/img/<YYYYMMDD>/webp/
...
# CSV・Excel出力先:
# detapachi/export/<site>/<YYYYMMDD>/
...
def open_browser(proxy_url=None):
    ...
    driver._detapachi_process_pids = (
        new_process_ids
    )

    driver._detapachi_profile_dir = (
        profile_dir
    )
